<template>
    ...
    >
        <el-sub-menu index="1">
            ...
            <el-menu-item-group>
                <el-menu-item index="1-1">Thống kê</el-menu-item>
            </el-menu-item-group>
        </el-sub-menu>
        ...
        <el-sub-menu index="7-8">
            ...
            <router-link to="/category">
                <el-menu-item index="7">Danh mục</el-menu-item>
            </router-link>
            <router-link to="/categoryoffer">
                <el-menu-item index="8">Danh mục ưu đãi</el-menu-item>
            </router-link>
        </el-sub-menu>
