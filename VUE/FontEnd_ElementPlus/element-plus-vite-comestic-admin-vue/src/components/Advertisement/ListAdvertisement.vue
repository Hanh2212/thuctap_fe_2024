...
import { Advertisment } from "~/constant/api";
import {
    deleteAdvertisement,
    searchAdvertisement,
...
const tableData = ref<Advertisment[]>([]);
...
const handleEdit = (index: number, row: Advertisment) => {
...
const fetchData = async (searchTerm: string = "") => {
    try {
        ...
        tableData.value = res.data.map(function (value: Advertisment) {
            return {
                id: value.id,
