...
//         `/api-user/SanPham/search-sanpham-ban-chay`,
//         data
//     );
//     return res?.data;
// };
...
//     const res = await apiClient?.post(
//         `/api-user/SanPham/search-sanpham-luot-xem-nhieu`,
//         data
//     );
//     return res?.data;
// };
...
//     const res = await apiClient?.post(
//         `/api-user/SanPham/search-sanpham-gia-tang`,
//         data
//     );
//     return res?.data;
// };
...
//     const res = await apiClient?.post(
//         `/api-user/SanPham/search-sanpham-gia-giam`,
//         data
//     );
//     return res?.data;
// };
